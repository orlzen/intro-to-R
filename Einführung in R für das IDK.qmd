...
-   Eigene Syntaxstruktur, aufbauend / hintereinander verknüpft, weniger verschachtelt als base R (wo man beim lesen mehrerer Funktionen "von innen" anfangen muss):
    ...
    3.  Verknüpfung mit dem "Pipe"-Operator (`|>` (früher `%>%`))
...
# Mit base R
virginica_base <- transform(subset(iris, Species == "virginica"), sepallength_width = (Sepal.Length + Sepal.Width), petallength_width = (Petal.Length + Petal.Width))
