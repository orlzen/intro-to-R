...
Diese Einleitung und Übersicht ist sicher nicht komplett und wird laufend ergänzt. Bitte melden bei bibs\@zhaw.ch, wenn etwas falsch oder unverständlich ist, fehlt oder ergänzt werden sollte.
:::
...
-   Das {conflicted}-Paket @conflicted hilft bei Konflikten, indem es die Konflikte explizit benennt und Lösungen vorschlägt.
    -   **Achtung**: Die Ausführung von nicht eindeutigen Befehlen wird angehalten, wenn das {conflicted}-Paket geladen ist!
