...
-   Siehe hier [https://rstats.wtf/projects](https://rstats.wtf/projects)
...
-   Sobald Code mit jemand anderem (oder auch nur einem anderen eigenen Computer mit anderer Ordnerstruktur) geteilt werden soll: Allgemein gültige Pfade benutzen mit dem Paket {here} [@here] -\> laden am Anfang mit `library(here)`
    -   R arbeitet dann aus einem designierten Projektordner heraus, der irgendwo abgelegt werden kann (siehe [https://rstats.wtf/practice-safe-paths](https://rstats.wtf/practice-safe-paths).
